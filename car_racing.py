...
def loop_game(num, inicio_estrada=estrada.inicio_estrada, final_estrada=estrada.final_estrada,
    ...
    lista_carros_inimigos = [
        pygame.transform.scale(
            carros.carro_azul, (largura_carro, altura_carro)),
        pygame.transform.scale(
            carros.carro_verde, (largura_carro, altura_carro)),
        pygame.transform.scale(
            carros.carro_azul, (largura_carro, altura_carro)),
        pygame.transform.scale(
            carros.carro_verde, (largura_carro, altura_carro)),
    ...
    if num == 2:
        while rodando:
            ...
            # recebendo o resto da divisao de rel_x pela altura da tela
            rel_y = altura % bg.get_rect().height
            # recriando o bg com base no resto da divisao
            tela.blit(bg, (0, rel_y - bg.get_rect().height))
            ...
            if pos_inimigo_y > 719:
                ...
                pos_inimigo_x = [posicoes_respawn[0], posicoes_respawn[1],
                                 posicoes_respawn[2], posicoes_respawn[3]]
                pos_inimigo_y = -100

            # retangulos colisao
            blit_carro_principal = tela.blit(
                carro_principal, (pos_jogador_x, pos_jogador_y))
            blits_carros_inimigos = [tela.blit(lista_carros_inimigos[0], (pos_inimigo_x[0], pos_inimigo_y)),
                                     tela.blit(
                                         lista_carros_inimigos[1], (pos_inimigo_x[1], pos_inimigo_y)),
                                     tela.blit(
                                         lista_carros_inimigos[2], (pos_inimigo_x[2], pos_inimigo_y)),
            ...
            for i in range(4):
                if blit_carro_principal.colliderect(blits_carros_inimigos[i]):
                    ...
                    text_formatado = font_2.render(
                        messagem, True, (255, 255, 255), (0, 0, 0))
                    text_formatado_2 = font_2.render(
                        messagem_2, True, (255, 255, 255), (0, 0, 0))
            ...
            tela.blit(lista_carros_inimigos[0],
                      (pos_inimigo_x[0], pos_inimigo_y))
            tela.blit(lista_carros_inimigos[1],
                      (pos_inimigo_x[1], pos_inimigo_y))
            tela.blit(lista_carros_inimigos[2],
                      (pos_inimigo_x[2], pos_inimigo_y))
            tela.blit(lista_carros_inimigos[3],
                      (pos_inimigo_x[3], pos_inimigo_y))
